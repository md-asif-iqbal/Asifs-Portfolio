      ...
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[21rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        <div className="pt-4 pb-6 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
          <div className=" items-center justify-between">
            ...
            <a className="text-sm bg-emerald-400/[0.7] px-3 py-1 uppercase tracking-wider text-white rounded-full dark:text-white/70" href={liveUrl} target="_blank">Live view</a>
            </div>
